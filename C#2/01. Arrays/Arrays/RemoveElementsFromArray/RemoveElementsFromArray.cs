...
namespace _18_Remove_Element_Yet_Again
{
    class _18_Remove_Elements_Correct
    {
        static void Main()
        {
            ...
            // input 
            int arraySize = int.Parse(Console.ReadLine());            // Търсим максималната нарастваща поредица която е възможна в този вид на масива и я вадим от цялата

            var toSearch = new int[arraySize];                       // дължина на масива - така откриваме колко елемента трябва да бъдат премахнати.
